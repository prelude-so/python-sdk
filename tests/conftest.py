...
def client(request: FixtureRequest) -> Iterator[Prelude]:
    ...
    with Prelude(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncPrelude]:
    ...
    async with AsyncPrelude(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
